...
def test_double_sdes():
    ...
    texte_chiffre_1 = chiffrement_sdes(CONST.PREMIERE_CLE_TEST,
                                       CONST.TEXTE_TEST)
    print("Texte chiffré 1er passage : \n", texte_chiffre_1)
    texte_chiffre_2 = chiffrement_sdes(CONST.DEUXIEME_CLE_TEST,
                                       texte_chiffre_1)
    print("Texte chiffré 2e passage : \n", texte_chiffre_2)
    texte_dechiffre_1 = dechiffrement_sdes(CONST.DEUXIEME_CLE_TEST,
                                           texte_chiffre_2)
    print("Texte déchiffré 1er passage : \n", texte_dechiffre_1)
    texte_dechiffre_2 = dechiffrement_sdes(CONST.PREMIERE_CLE_TEST,
                                           texte_dechiffre_1)
